...
public abstract record ContactoError(string Message) : DomainError(Message) {
    ...
    /// <summary>
    /// Error de Contacto no encontrado según ID
    /// </summary>
    ...
    /// <summary>
    /// Error de Contacto no encontrado según Alidas
    /// </summary>
    ...
    /// <summary>
    /// Error de validación en el Contacto
    /// </summary>
